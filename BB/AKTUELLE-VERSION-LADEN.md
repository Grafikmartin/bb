...
- Jeden Tab schließen, in dem `localhost:5170` oder `/bb/` offen ist.
...
- Warten, bis „Local: http://localhost:5170/“ erscheint.

## 3. Seite ohne Cache laden
**Variante A – Empfohlen:**
- **Neues privates Fenster** öffnen (Chrome: Cmd+Shift+N).
- Adresszeile: **http://localhost:5170/bb/** eintippen (nicht aus Lesezeichen).
- Enter.

**Variante B – Cache in DevTools deaktivieren:**
- Normales Fenster: **http://localhost:5170/bb/** öffnen.
- **F12** (DevTools).
...
## Wichtig
- Immer **http://localhost:5170/bb/** nutzen (mit Port **5174**).
